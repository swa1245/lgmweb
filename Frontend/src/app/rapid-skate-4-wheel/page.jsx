...
//       return;
//     }
//     addToCart({ id: product.id, type: 'inline-skate', name: product.name, price: product.price, quantity: 1 });
...
//             <img src={product.images[currentImage]} alt={product.name} className="w-full h-[60vh] object-contain" />
...
//             <p className="text-xl text-blue-600 font-semibold">₹{product.price.toLocaleString()}</p>
...
//               </ul>
//             </div>
//             <button onClick={handleAdd} className="px-6 py-3 rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition">Add to Cart</button>
//           </div>
//         </div>
//       </div>
//     </div>
...
//       return;
//     }
//     toast.success('Add to cart clicked (no cart logic)');
//   };
