...
// Images
import rubberWheelSet from "public/assets/27-Rubber Wheel Set/WhatsApp Image 2025-07-07 at 12.59.52_fb0f8fbd.jpg";

import tyroWheelSet1 from "/public/assets/28-Tyro Wheel Set/AARMS Photography-128.jpg";
import tyroWheelSet2 from "/public/assets/28-Tyro Wheel Set/AARMS Photography-129.jpg";
import tyroWheelSet3 from "/public/assets/28-Tyro Wheel Set/AARMS Photography-130.jpg";

import hyperRolloWheelSet1 from "/public/assets/29-Hyper Rollo Wheel Set/1000211310.png";
import hyperRolloWheelSet2 from "/public/assets/29-Hyper Rollo Wheel Set/1000211313.png";
import hyperRolloWheelSet3 from "/public/assets/29-Hyper Rollo Wheel Set/1000211352.png";


import viperWheelSet1 from "/public/assets/30-Viper Wheel Set/AARMS Photography-120.jpg";
import viperWheelSet2 from "/public/assets/30-Viper Wheel Set/AARMS Photography-121.jpg";



import omenWheelSet1 from "/public/assets/31-Omen Wheel Set/AARMS Photography-124.jpg";
import omenWheelSet2 from "/public/assets/31-Omen Wheel Set/AARMS Photography-125.jpg";



import yoruWheelSet1 from "/public/assets/32-Yoru Wheel Set/AARMS Photography-122.jpg";
import yoruWheelSet2 from "/public/assets/32-Yoru Wheel Set/AARMS Photography-123.jpg";
...
export default function Hangers() {
  ...
  const products = [
    {
      id: "rubber-wheel-set",
      name: "Rubber Wheel Set",
      image: rubberWheelSet,
      images: [rubberWheelSet],
      price: 400,
      countInStock: 20,
      description:
    ...
    {
      id: "tyro-wheel-set",
      name: "Tyro Wheels Set",
      image: tyroWheelSet1,
      images: [tyroWheelSet1, tyroWheelSet2, tyroWheelSet3],
      price: 400,
      countInStock: 20,
      description:
        "High-quality classic quad hanger for recreational skating with enhanced durability",
    ...
    {
      id: "hype-rollo-wheel-set",
      name: "Hyper Rollo Wheel Set",
      image: hyperRolloWheelSet1,
      images: [hyperRolloWheelSet1, hyperRolloWheelSet2, hyperRolloWheelSet3],
      price: 400,
      countInStock: 20,
      description:
        "High-quality classic quad hanger for recreational skating with enhanced durability",
    ...
    {
      id: "viper-wheel-set",
      name: "Viper Wheel Set",
      image: viperWheelSet1,
      images: [viperWheelSet1, viperWheelSet2],
      price: 400,
      countInStock: 20,
      description:
        "High-quality classic quad hanger for recreational skating with enhanced durability",
    ...
    },
    {
      ...
      name: "Omen Wheel Set",
      image: omenWheelSet1,
      images: [omenWheelSet1, omenWheelSet2],
      price: 400,
      countInStock: 20,
      description:
        "High-quality classic quad hanger for recreational skating with enhanced durability",
    ...
    },
    {
      ...
      name: "Yoru Wheel Set",
      image: yoruWheelSet1,
      images: [yoruWheelSet1, yoruWheelSet2],
      price: 400,
      countInStock: 20,
      description:
        "High-quality classic quad hanger for recreational skating with enhanced durability",
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="border-b border-gray-200 mb-8">
          ...
          <p className="text-lg text-gray-600 mb-6 font-['Arimo']">
            Professional quad wheels for optimal skating performance
          </p>
