...
// Images
import sunglasses1 from "/public/assets/167 -Sun Glasess/AARMS Photography-23.jpg";
import sunglasses2 from "/public/assets/167 -Sun Glasess/AARMS Photography-24.jpg";
import sunglasses3 from "/public/assets/167 -Sun Glasess/AARMS Photography-25.jpg";
import sunglasses4 from "/public/assets/167 -Sun Glasess/AARMS Photography-26.jpg";
  ...
  const products = [
    {
      ...
      name: "Sunglasses",
      image: sunglasses1,
      images: [sunglasses1, sunglasses2, sunglasses3, sunglasses4],
      price: 2200,
      countInStock: 20,
      description:
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="border-b border-gray-200 mb-8">
          ...
          <p className="text-lg text-gray-600 mb-6 font-['Arimo']">
            Perfect for outdoor activities, sports, and everyday wear, these
            sunglasses combine comfort, clarity, and fashion in one.
          </p>
