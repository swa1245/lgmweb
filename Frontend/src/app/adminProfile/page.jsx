...
// const AdminProfile = () => {
//   const adminEmail = "admin@example.com"; // Replace with dynamic value later
...
//           Welcome back, <span className="font-semibold text-gray-700">{adminEmail.split('@')[0]}</span>
//         </p>
...
//         {/* Logout */}
//         <button className="flex items-center justify-center gap-2 bg-red-500 hover:bg-red-600 text-white font-semibold px-6 py-2 rounded-lg shadow hover:scale-105 transition-transform duration-200">
//           <LogOut size={18} />
//           Logout
//         </button>
//       </div>
