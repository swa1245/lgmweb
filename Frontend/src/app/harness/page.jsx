...
export default function Harness() {
  ...
  const product = {
    id: "harness-5",
    name: "Harness",
    description: "Professional training harness for skaters and athletes. Designed for resistance training and technique development with comfortable fit and adjustable straps.",
    price: 500,
    image: "/assets/130 - Harness/1000211284.png",
    images: ["/assets/130 - Harness/1000211284.png"],
    countInStock: 15,
    features: [
      "Ergonomic design for comfortable fit",
      "Adjustable straps for different body types",
      "Multiple attachment points for training tools",
      "Breathable material for extended use",
      "Quick-release buckles for safety"
    ],
    specs: {
      material: "Reinforced nylon with padded straps",
      weight: "320g",
