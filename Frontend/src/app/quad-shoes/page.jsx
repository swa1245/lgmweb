...
const QuadShoesPage = () => {
  ...
  const product = {
    ...
    features: [
      ...
      "Available in sizes 36-46 (EU)"
    ],
    specifications: {
      "Upper Material": "Synthetic leather with reinforced panels",
      "Lining": "Breathable mesh",
      "Insole": "Removable cushioned EVA",
      "Closure": "Traditional lace-up with ankle strap",
      "Weight": "Approximately 0.8kg per shoe",
      "Compatibility": "All standard quad frames",
      "Available Sizes": "36-46 (EU)",
      "Colors Available": "Black, White, Red/Black"
    }
  };
