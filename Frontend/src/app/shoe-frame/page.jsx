...
const ShoeFramePage = () => {
  ...
  const products = [
    {
      id: "A0055-clasic-yellow-frame-quad-shoes",
      name: "Clasic Yellow Frame + Quad Shoes",
      price: 3472,
      image: placeholderImage,
      images: [placeholderImage, placeholderImage],
      countInStock: 15,
      description:
        "Combo of Clasic Yellow Frame with Quad Shoes, offering balanced performance and comfort.",
      specs: {
        brand: "Generic",
        wheelSetup: "Quad",
        frame: "Nylon",
    ...
    {
      id: "A0056-nylon-yellow-black-frame-quad-shoes",
      name: "Nylon Yellow / Black Frame + Quad Shoes",
      price: 4144,
      image: placeholderImage,
      images: [placeholderImage, placeholderImage],
      countInStock: 15,
      description:
        "Durable Nylon Yellow/Black Frame combined with Quad Shoes for reliable skating.",
      specs: {
        brand: "HQ",
        wheelSetup: "Quad",
        frame: "Nylon",
    ...
    {
      id: "A0057-nylon-yellow-black-frame-nivia-shoes",
      name: "Nylon Yellow / Black Frame + NIVIA Shoes",
      price: 5040,
      image: placeholderImage,
      images: [placeholderImage, placeholderImage],
      countInStock: 15,
      description:
        "High-performance Nylon Yellow/Black Frame paired with NIVIA Shoes for stylish skating.",
      specs: {
        brand: "NIVIA",
        wheelSetup: "Quad",
        frame: "Nylon",
    ...
    {
      id: "A0058-aluminium-frame-hq-shoes",
      name: "Aluminium Frame + HQ Shoes",
      price: 11536,
      image: placeholderImage,
      images: [placeholderImage, placeholderImage],
      countInStock: 15,
      description:
        "Premium Aluminium Frame with HQ Shoes designed for professional quad skating.",
      specs: {
        brand: "HQ",
        wheelSetup: "Quad",
        frame: "Aluminium",
    ...
    {
      id: "A0059-aluminium-frame-nivia-shoes",
      name: "Aluminium Frame + NIVIA Shoes",
      price: 12320,
      image: placeholderImage,
      images: [placeholderImage, placeholderImage],
      countInStock: 15,
      description:
        "Strong Aluminium Frame matched with NIVIA Shoes for durability and smooth skating.",
      specs: {
        brand: "NIVIA",
        wheelSetup: "Quad",
        frame: "Aluminium",
         ...
         <div className="container mx-auto px-4 py-8">
           ...
           <div className="border-b border-gray-200 mb-8">
             ...
             <p className="text-lg text-gray-600 mb-6 font-['Arimo']">
               Premium shoe and frame combinations for optimal skating performance
             </p>
