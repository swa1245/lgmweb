...
const HQQuadPackagePage = () => {
  ...
  const products = [
    {
      id: "A0045-clasic-yellow-frame",
      name: "Clasic Yellow Frame",
      price: 1792,
      image: placeholderImage,
      images: [placeholderImage, placeholderImage],
      countInStock: 15,
      description:
        "Durable Clasic Yellow quad frame built for stability and long-lasting use.",
      specs: {
        brand: "Generic",
        wheelSetup: "Quad",
        frame: "Nylon",
    ...
    {
      id: "A0046-nylon-yellow-black-frame-hq",
      name: "Nylon Yellow / Black Frame HQ",
      price: 2016,
      image: placeholderImage,
      images: [placeholderImage, placeholderImage],
      countInStock: 15,
      description:
        "HQ Nylon frame in yellow/black colorway designed for balanced quad skating.",
      specs: {
        brand: "HQ",
        wheelSetup: "Quad",
        frame: "Nylon",
    ...
    {
      id: "A0047-aluminium-quad-frame-nylon-hanger",
      name: "Aluminium Quad Frame With Naylon Hanger",
      price: 9520,
      image: placeholderImage,
      images: [placeholderImage, placeholderImage],
      countInStock: 15,
      description:
        "Strong aluminium quad frame paired with a nylon hanger for versatile skating.",
      specs: {
        brand: "Generic",
        wheelSetup: "Quad",
        frame: "Aluminium + Nylon",
      },
    },
    
    {
      id: "A0048-aluminium-quad-frame-metal-hanger",
      name: "Aluminium Quad Frame With Metal Hanger",
      price: 10640,
      image: placeholderImage,
      images: [placeholderImage, placeholderImage],
      countInStock: 15,
      description:
        "Premium aluminium quad frame equipped with a metal hanger for durability and precision.",
      specs: {
        brand: "Generic",
        wheelSetup: "Quad",
        frame: "Aluminium + Metal",
      },
    },
