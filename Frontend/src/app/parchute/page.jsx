...
export default function Parchute() {
  ...
  const product = {
    id: "parchute-4",
    name: "Parchute",
    description: "Professional training parachute for skaters and athletes. Increases resistance during training to build strength, speed, and endurance.",
    price: 650,
    image: "/assets/129 - Parchute/1000211301.png",
    images: ["/assets/129 - Parchute/1000211301.png"],
    countInStock: 20,
    features: [
      "Adjustable resistance levels",
      "Quick-release mechanism for safety",
      "Durable nylon construction",
      "Comfortable harness attachment",
