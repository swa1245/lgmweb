...
// //               Home
// //             </Link>
// //             <Link href="/inline-skates" className="hover:text-blue-600">Inline Skates</Link>
// //             <Link href="/quad-skates" className="hover:text-blue-600">Roller/Quad Skates</Link>
...
// //               {showDropdown && (
// //                 <div className="absolute top-8 left-0 bg-white w-48 shadow-lg border rounded z-50">
// //                   <Link href="/hockey-skates" className="block px-4 py-2 text-black font-semibold hover:bg-gray-100">Hockey Skates</Link>
// //                   <Link href="/workout-gear" className="block px-4 py-2 text-black font-semibold hover:bg-gray-100">Workout Gear</Link>
// //                 </div>
// //               )}
// //             </div>

// //             <Link href="/hockey-skates" className="hover:text-blue-600">Hockey Skates</Link>
// //             <Link href="/workout-gear" className="hover:text-blue-600">Workout Gear</Link>
...
// //       {mobileMenu && (
// //         <div className="md:hidden bg-white shadow-md px-6 py-4 space-y-2 text-sm font-medium text-gray-800">
// //           <Link href="/inline-skates" className="block">Inline Skates</Link>
// //           <Link href="/quad-skates" className="block">Roller/Quad Skates</Link>
// //           <Link href="/hockey-skates" className="block">Hockey Skates</Link>
// //           <Link href="/workout-gear" className="block">Workout Gear</Link>
...
//     `px-4 py-2 rounded-full font-medium transition-colors duration-150 ease-in-out ${
//       isActive(path)
//         ? "bg-[#e6f0ff] text-black border border-[#c2ddff]"
//         : "hover:text-blue-600"
//     }`;
...
//             <Link href="/inline-skates" className={navLinkClass("/inline-skates")}>
//               Inline Skates
//             </Link>
...
//             <Link href="/hockey-skates" className={navLinkClass("/hockey-skates")}>
//               Hockey Skates
//             </Link>

//             <Link href="/workout-gear" className={navLinkClass("/workout-gear")}>
//               Workout Gear
//             </Link>
...
//                 isActive(href) ? "bg-[#e6f0ff] text-black border border-[#c2ddff]" : "hover:text-blue-600"
//               }`}
//             >
//               {label}
//             </Link>
