        ...
        <div className="flex flex-col lg:flex-row items-center gap-20 font-['Poppins']">
          ...
          <div className="lg:w-1/2 space-y-10">
            <div className="space-y-4">
              <div className="inline-block px-3 py-1 border-l-2 border-sky-500 text-sky-600 text-sm font-medium tracking-wider font-['Poppins']">
                INNOVATIVE DESIGN
              </div>
              <h2 className="text-5xl font-light text-gray-900 leading-tight">
                ONE PIECE{" "}
                <span className="font-semibold text-orange-500">CONSTRUCTION</span>
              </h2>
          ...
          <div className="lg:w-1/2 mt-16 lg:mt-0">
            <div className="relative">
              <div className="relative z-10 overflow-hidden group">
                ...
                <div className="absolute bottom-0 left-0 p-8 w-full z-20 font-['Poppins']">
