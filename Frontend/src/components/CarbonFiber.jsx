          ...
          <div className="lg:w-1/2 w-full mt-16 lg:mt-0">
            <div className="relative">
              <div className="relative z-10 overflow-hidden group rounded-lg ">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-gray-900/70 to-transparent font-[Arimo]"></div>
                <div className="absolute bottom-0 left-0 p-6 sm:p-8 w-full z-20 font-[Arimo]">
                  <div className="space-y-3 font-[Arimo]">
                    <div className="flex items-center gap-2 font-[Arimo]">
                      <div className="w-6 h-0.5 bg-orange-500"></div>
                      <span className="text-orange-400 text-xs font-medium uppercase tracking-wider font-[Arimo]">
                        Premium Material
                      </span>
                    </div>
                    <h3 className="text-white text-xl sm:text-2xl font-light font-[Arimo]">
                      Advanced <span className="font-semibold">Technology</span>
                    </h3>
                    <p className="text-gray-300 text-sm font-light max-w-xs leading-relaxed font-[Arimo]">
